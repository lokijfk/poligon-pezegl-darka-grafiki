...
public partial class MainWindowViewModel : ObservableObject
{
    ...
    */
    ...
    {     
        ...
        {
            Shortcut.Create(lnkFileName, PathToExe, null, null, "Poligon Przeglądarka Grafiki", string.Empty, PathToIco);
        }
    }
    ...
    */
    ...
    private object GaleryCan() => new GalleryCan();
    ...
    */
    ...
    private async void PhotosLoadImae(CancellationToken token)
    {
        if (Photos.Count > 0)
        {
