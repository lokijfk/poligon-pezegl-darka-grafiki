...
public partial class Gallery : UserControl
{
    ...
    public static RoutedCommand DeleteStrong = new RoutedCommand();
    ...
    void NSCommand_CanExecute(object sender, CanExecuteRoutedEventArgs e)
    {
        /*
        if (GetSelectedPhotos().Length != 0)
        {
    ...
    void RenameCommand_CanExecute(object sender, CanExecuteRoutedEventArgs e)
    {
    ...
    void DeleteCommand_Executed(object sender, ExecutedRoutedEventArgs e)
    {
        if (GetSelectedPhotos().Length > 0)
        {   
            (DataContext as MainWindowViewModel).DeleteFile(GetSelectedPhotos());
        }
    }

    void DeleteStrong_Executed(object sender, ExecutedRoutedEventArgs e)
    {
        if (GetSelectedPhotos().Length > 0)
        {
            (DataContext as MainWindowViewModel).DeleteFile(GetSelectedPhotos());
    ...
    void OpenCommand_Executed(object sender, ExecutedRoutedEventArgs e)
    {
          ...
          {
               if (Lista.SelectedItem is Photo ph)
               {
                    ViewSelectedImage(Lista, ph);
                    e.Handled = true;
               }
          }
    ...
    {
        Debug.WriteLine("SelectAllCommand_Executed");
        Debug.WriteLine("tryb zaznaczania: "+Lista.SelectionMode);
    ...
    private void ListBoxItem_PreviewMouseRightButtonDown(object sender, MouseButtonEventArgs e)
    {
        ...
        (DataContext as MainWindowViewModel).RefreshClipboardListenerResoult();
    }
    ...
    */
    ...
    /*
        private void Lista_SourceUpdated(object sender, System.Windows.Data.DataTransferEventArgs e)
        {
            Debug.WriteLine("source update");
        }

        private void Lista_TargetUpdated(object sender, System.Windows.Data.DataTransferEventArgs e)
        {
        ...
        private void Lista_SourceUpdated(object sender, System.Windows.Data.DataTransferEventArgs e)
        {
            Debug.WriteLine("Lista_SourceUpdated");
        }

        private void Lista_TargetUpdated(object sender, System.Windows.Data.DataTransferEventArgs e)
        {
            Debug.WriteLine("Lista_TargetUpdated");
