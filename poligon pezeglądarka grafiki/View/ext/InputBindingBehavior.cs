...
public class InputBindingBehavior
{
    ...
    {
        Debug.WriteLine("InputBindingBehavior: OnPropagateInputBindingsToWindowChanged called");
    ...
    {
        Debug.WriteLine("InputBindingBehavior: OnFrameworkElementLoaded called");
